...
feature "user successfully creates and deletes bookmark" do
  scenario "authenticated user successfully deletes a bookmark" do
    ...
    click_link "Delete"
    expect(page).to have_content("Reddit has been deleted")
  end
end
